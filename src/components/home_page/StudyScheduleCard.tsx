...
export default function StudyScheduleCard({ title }: StudyScheduleCardProps) {
  return (
    <div className="h-[220px] w-[570px] overflow-hidden rounded-xl bg-white shadow-sm">
      <div className="flex items-center justify-between bg-[#EBEBEB] px-[32px] py-[12px]">
        ...
        <button className="rounded-full border border-gray-300 bg-white px-4 py-1 text-sm font-bold text-[#3D51AF] hover:cursor-pointer">
          #자세히
        </button>
      </div>
